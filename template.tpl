...

{
  ...
  "description": "This template defines coupon code page. It should be on the page that users can enter coupon code.",
  "containerContexts": [
    "WEB"
  ]
}
...
insiderObject.page = {type: 'Coupon'};
...
Created on 11/20/2020, 3:01:36 PM
